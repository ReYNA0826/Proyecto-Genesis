...
| PG-016 | **Prompts del Consejo Ejecutivo** (7 agentes) | `prompts/*-prompt-oficial.md` + `prompts/Manual de Prompts de Agentes v0.1.pdf` | ✅ **v0.3 (S08)** — cargos C-Suite de PG-020 aplicados en repo Y en los cerebros de ElevenLabs (ALMA=CEO, LEX=CLO, TECH=CTO, OPS=COO, FIN=CFO, MKT=**CGO** con Depto. de Inteligencia Comercial, EDU=Chief Learning Officer). Bloques `Idioma`/`IMPORTANTE` preservados (get-before-update). ⚠️ "Mi alma" (app iOS) y "Andrés Felipe" (llamadas) son OTROS agentes, de producción — NO TOCAR. Pendiente menor: FIN tiene `language:"en"` en ElevenLabs (todo lo demás en español) |
